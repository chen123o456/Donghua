...
public class MainActivity extends AppCompatActivity {
    ...
    public void zong2(View view){
        ...
        ObjectAnimator rotate = ObjectAnimator.ofFloat(imageView, "rotation", 0,360f,0,180f,-360f);
        ObjectAnimator translationY = ObjectAnimator.ofFloat(imageView, "translationY", 0f, 200f, 500f,0f);
        ObjectAnimator translationX = ObjectAnimator.ofFloat(imageView, "translationX", 0f, 200f, 100f,0f);
        ObjectAnimator alpha = ObjectAnimator.ofFloat(imageView, "alpha", 1f, 0f, 1f);
        AnimatorSet set = new AnimatorSet();
        set.play(scaleX).with(scaleY).with(alpha).with(rotate).with(translationX).with(translationY);
